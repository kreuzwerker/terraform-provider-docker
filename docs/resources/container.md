...
- `group` (String) The group of the file in the container. Names are resolved using the Terraform host's group database; numeric IDs can be used directly.
- `owner` (String) The owner of the file in the container. Names are resolved using the Terraform host's user database; numeric IDs can be used directly.
